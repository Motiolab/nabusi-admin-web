...
import WellnessLectureListUpdateView from '@/views/wellnessclass/WellnessLectureListUpdateView'
...
function App() {
  ...
  const routesContent = (
    <Routes>
      ...
      <Route path="/wellness-lecture-list/update" element={<WellnessLectureListUpdateView />} />
